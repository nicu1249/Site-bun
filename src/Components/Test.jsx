...
function Test() {
 ...
 const { enterCount } = useInViewport(
  ...
  return (
    ...
    <VStack>
    <Heading style={{ maxWidth:500}} textColor='white' align='center'><Wave  text= 'The No. 1 service provider across all blockchains' effect="fadeIn" effectChange={1.7} effectSpeed={3.8}/></Heading>
  <HStack>
